...
export async function generateMetadata({params}: _Props): Promise<Metadata> {
  ...
  try {
    ...
    return {
      ...
      description: 'Vale por un texto random'
    }
  }
}
...
export default async function PokemonPage({ params }: _Props) {
